...
public class ProfNavegar2Servlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Logger.getLogger(ProfNavegar2Servlet.class.getName()).info("Materiales disponibles y visibles:" + mdao1.readFROMTEMA(m1));
		session.setAttribute("ListaMaterial", materialList);
		response.sendRedirect("jsp/profesor/navegar3.jsp");
	}
