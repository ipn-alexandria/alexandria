...
public class ModNavegar2Servlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Logger.getLogger(ModNavegar2Servlet.class.getName()).info("Materiales disponibles y visibles:" + mdao1.readFROMTEMA(m1));
		session.setAttribute("ListaMaterial", materialList);
		response.sendRedirect("jsp/moderador/navegar3.jsp");
	}
