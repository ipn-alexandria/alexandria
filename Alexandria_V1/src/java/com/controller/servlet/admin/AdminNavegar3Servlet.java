...
public class AdminNavegar3Servlet extends HttpServlet {
	...
	try (OutputStream out = response.getOutputStream()) {
		...
		response.sendRedirect("jsp/administrador/vervideo.jsp");
	    } else if (idtipom == 0) {
		...
		response.sendRedirect("jsp/administrador/verpdf.jsp");
	    }
	}
    }
