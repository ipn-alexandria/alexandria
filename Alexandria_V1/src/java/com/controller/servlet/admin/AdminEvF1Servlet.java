...
public class AdminEvF1Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ProfEvF1Servlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AdminEvF1Servlet at " + request.getContextPath() + "</h1>");
            ...
            if (rfiltro1 == 1) {
                ...
                response.sendRedirect("jsp/administrador/evaluarFiltro1.jsp");
            }
            else {
                m1.setIdMaterial(idmat);
                mdao1.delete(m1);
