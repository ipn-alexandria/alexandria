...
public class AdminSubirMaterialServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AdminSubirMaterialServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AdminSubirMaterialServlet at " + request.getContextPath() + "</h1>");
            ...
            if (timat == 1) {
                ...
                response.sendRedirect("jsp/administrador/subirvideo.jsp");
            }
            else {
                idactual=Integer.toString(idmatup);
                System.out.println("Dato enviado ID a subirpdf: " + idactual);
                session.setAttribute("idmatup", idactual); 
                response.sendRedirect("jsp/administrador/subirpdf.jsp");
            }
