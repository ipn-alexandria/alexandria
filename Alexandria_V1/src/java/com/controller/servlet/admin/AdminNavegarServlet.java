...
public class AdminNavegarServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AdminNavegarServlet at " + request.getContextPath() + "</h1>");
            ...
            response.sendRedirect("jsp/administrador/navegar2.jsp");
